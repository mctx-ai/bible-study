...
**Key Features:**
- 8 tools: verse lookup, chapter reading, full-text search, semantic search, cross-references, concordance, word study, topical search
- 2 resources: verse URI, chapter URI
...
src/
  ...
  resources/          → One file per resource (verse, chapter)
...
| `release` | Deployment artifact | `dist/index.js`, `package.json`, `README.md`, `.dist-hash` only |
